...
@Slf4j
public class CloudConfigClientWatch implements Closeable, EnvironmentAware {
  ...
  private String fetchNewVersion() {
    try {
      CompositePropertySource propertySource = (CompositePropertySource) locator.locate(
        environment);
